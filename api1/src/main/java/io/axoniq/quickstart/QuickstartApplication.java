 ...
 *   <li><strong>Outbound Queries</strong>: Demonstrates dispatching query messages to the read service</li>
 * </ul>
 *
 ...
 *   <li>Observe real-time gift card issuance and redemption driven by the scheduler</li>
 *   <li>Use the write-side API endpoints at /api/giftcards</li>
 * </ol>
 *
...
public class QuickstartApplication {
     ...
     *   <li>Event store and command bus configuration</li>
     *   <li>Aggregate registration</li>
